...
La criminología siguió trabajando estas áreas, con un grado creciente de sofisticación estadística y metodológica [@Medina_23] hasta nuestros días. Hoy esta es una de las áreas de mayor actividad investigadora en la criminología.
...
El mes del año es un fuerte indicador de los niveles de delincuencia en muchos contextos, lo que respalda el uso de la estacionalidad en la previsión de la delincuencia y la asignación de recursos. Sin embargo, existen excepciones: algunos delitos (por ejemplo, los homicidios) muestran una estacionalidad débil o inconsistente, y los patrones microespaciales pueden permanecer estables incluso cuando las tasas generales fluctúan. La pandemia de COVID-19 y otras perturbaciones sociales importantes pueden anular los patrones estacionales típicos.
