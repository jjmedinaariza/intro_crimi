...
- Algunas imágenes fueron editadas y montadas con la ayuda de Claude. Por ejemplo, cuando insertamos varias portadas de libros de forma conjunta enviamos un prompt para que las imágenes que habíamos conseguido estuvieran montadas en un solo png.
...
- Hemos utilizado una IA para verificar que todos los capítulos usan de forma consistente las convenciones sobre lenguaje no sexista que hemos señalado y para identificar aquellos puntos donde era necesario hacer algún cambio.
